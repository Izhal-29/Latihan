...
<body>
  <div class="sidebar">
    <div class="logo-content">
      <div class="logo">
        ...
        <div class="logo-name">WATCH <span class="text-warning"> Katalog </span></div>
      </div>
  ...
  <div class="home-content">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
          <a class="btn btn-primary tambah" href="tambah.php"> <i class="bi-plus-circle-fill"> Tambah Supplier </i> </a>
        </div>
      </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center aksi"> 
                  <a href="edit.php?id=<?= $s['id']; ?>" class="btn btn-warning"> <i class="bi-pencil-square"> Edit </i> </a> 
                  <a href="hapus.php?id=<?= $s['id']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ?');"> <i class="bi-trash3"> Hapus </i> </a>
                </td>
              </tr>
              <?php 
                $no++;
